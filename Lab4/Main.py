...
file_names = ['easy1', 'easy2', 'easy3', 'easy_01_tsp', 'mediumF', 'berlin']
...
def run_test(file_name, generation_type, nr_pop, nr_gen):
    ...
    best_chromosomes.append(best_chromosome.fitness())
    last_fitness = 0
    same_fitness = 1
    ...
    draw_result(file_name, best_chromosomes, 'red')
...
def draw_result(file_name, best_chromosomes, color):
    plot.ylabel('Best chromosomes')
    plot.plot(best_chromosomes, color)
