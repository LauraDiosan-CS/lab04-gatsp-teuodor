...
class Chromosome:
    ...
    def crossover(self, other):
        index1 = randint(0, self.__param['nr_nodes'] - 2)
        index2 = randint(0, self.__param['nr_nodes'] - 2)

        if index2 < index1:
            index2, index1 = index1, index2

        new_representation = self.__representation[index1:index2 + 1]
